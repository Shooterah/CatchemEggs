...
void fallEggs(MLV_Image *background, MLV_Image *posJoueur, Player joueur1, int sortie_jeu){
  ...
  while(!sortie){
    ...
    MLV_draw_adapted_text_box(0, 20, score1, 20, MLV_COLOR_BLACK, MLV_COLOR_WHITE, MLV_COLOR_BLACK, MLV_TEXT_CENTER);

    MLV_draw_text(290, 0, "Fail", MLV_COLOR_WHITE);

    MLV_draw_adapted_text_box(270, 20, fail1, 20, MLV_COLOR_BLACK, MLV_COLOR_WHITE, MLV_COLOR_BLACK, MLV_TEXT_CENTER);
